...
import { validateCreateUser,validateLogout,validateLogin,validateRefreshToken } from "./auth.validation";
...
class AuthRoute implements Routes {
  ...
  private initializeRoutes() {
     ...
     this.router.post(`${this.path}/login`, [authenticate,validationMiddleware(validateLogin,'body')],this.controller.login);
  }
}
